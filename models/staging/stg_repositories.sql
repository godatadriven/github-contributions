select
    ...
    cast(owner_node_id as varchar) as owner_node_id,
    cast(owner_avatar_url as varchar) as owner_avatar_url,
    cast(owner_gravatar_id as varchar) as owner_gravatar_id,
    cast(owner_url as varchar) as owner_url,
    cast(owner_html_url as varchar) as owner_html_url,
    cast(owner_followers_url as varchar) as owner_followers_url,
    cast(owner_following_url as varchar) as owner_following_url,
    cast(owner_gists_url as varchar) as owner_gists_url,
    cast(owner_starred_url as varchar) as owner_starred_url,
    cast(owner_subscriptions_url as varchar) as owner_subscriptions_url,
    cast(owner_organizations_url as varchar) as owner_organizations_url,
    cast(owner_repos_url as varchar) as owner_repos_url,
    cast(owner_events_url as varchar) as owner_events_url,
    cast(owner_received_events_url as varchar) as owner_received_events_url,
    cast(owner_type as varchar) as owner_type,
    cast(owner_site_admin as boolean) as owner_site_admin,
    ...
    -- license
    cast(license_key as varchar) as license_key,
    cast(license_name as varchar) as license_name,
    cast(license_spdx_id as varchar) as license_spdx_id,
    cast(license_url as varchar) as license_url,
    cast(license_node_id as varchar) as license_node_id,
    ...
    -- organization
    -- CAST(organization_login AS VARCHAR) AS organization_login,
    -- CAST(organization_id AS INTEGER) AS organization_id,
    -- CAST(organization_node_id AS VARCHAR) AS organization_node_id,
    -- CAST(organization_avatar_url AS VARCHAR) AS organization_avatar_url,
    -- CAST(organization_gravatar_id AS VARCHAR) AS organization_gravatar_id,
    -- CAST(organization_url AS VARCHAR) AS organization_url,
    -- CAST(organization_html_url AS VARCHAR) AS organization_html_url,
    -- CAST(organization_followers_url AS VARCHAR) AS organization_followers_url,
    -- CAST(organization_following_url AS VARCHAR) AS organization_following_url,
    -- CAST(organization_gists_url AS VARCHAR) AS organization_gists_url,
    -- CAST(organization_starred_url AS VARCHAR) AS organization_starred_url,
    -- CAST(organization_subscriptions_url AS VARCHAR) AS
    -- organization_subscriptions_url,
    -- CAST(organization_organizations_url AS VARCHAR) AS
    -- organization_organizations_url,
    -- CAST(organization_repos_url AS VARCHAR) AS organization_repos_url,
    -- CAST(organization_events_url AS VARCHAR) AS organization_events_url,
    -- CAST(organization_received_events_url AS VARCHAR) AS
    -- organization_received_events_url,
    -- CAST(organization_"type" AS VARCHAR) AS organization_type,
    -- CAST(organization_site_admin AS BOOLEAN) AS organization_site_admin,
