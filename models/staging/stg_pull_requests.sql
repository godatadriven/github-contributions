SELECT
    ...
    CAST(milestone.open_issues AS TINYINT) AS open_issues,
    CAST(milestone.closed_issues AS TINYINT) AS closed_issues,
    CAST(milestone.state AS VARCHAR) AS state,
    CAST(milestone.created_at AS VARCHAR) AS created_at,
    CAST(milestone.updated_at AS VARCHAR) AS updated_at,
    CAST(milestone.due_on AS VARCHAR) AS due_on,
    CAST(milestone.closed_at AS VARCHAR) AS closed_at,
